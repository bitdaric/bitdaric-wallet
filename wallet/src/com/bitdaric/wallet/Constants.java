...
import org.libdarxj.params.AbstractBitdaricParams;
import org.libdarxj.params.BitdaricMainNetParams;
import org.libdarxj.params.BitdaricTestNet3Params;
...
public final class Constants {
    ...
    public static final NetworkParameters NETWORK_PARAMETERS = TEST ? BitdaricTestNet3Params.get() : BitdaricMainNetParams.get();

    /** Bitcoinj global context. */
    public static final Context CONTEXT = new Context(NETWORK_PARAMETERS);

    public final static class Files {
        private static final String FILENAME_NETWORK_SUFFIX = NETWORK_PARAMETERS.getId().equals(AbstractBitdaricParams.ID_DARX_MAINNET) ? "" : "-testnet";
        ...
        public static final String EXTERNAL_WALLET_KEY_BACKUP = "bitdaric-wallet-keys" + FILENAME_NETWORK_SUFFIX;

        /** Filename of the manual wallet backup. */
        public static final String EXTERNAL_WALLET_BACKUP = "bitdaric-wallet-backup" + FILENAME_NETWORK_SUFFIX;
    ...
    public static final String MIMETYPE_WALLET_BACKUP = "application/x-bitdaric-wallet-backup";

    /** Number of confirmations until a transaction is fully confirmed. */
    public static final int MAX_NUM_CONFIRMATIONS = 7;

    /** User-agent to use for network access. */
    public static final String USER_AGENT = "BitDaric Wallet";

    /** Default currency to use if all default mechanisms fail. */
    public static final String DEFAULT_EXCHANGE_CURRENCY = "USD";

    /** Donation address for tip/donate action. */
    public static final String DONATION_ADDRESS = NETWORK_PARAMETERS.getId().equals(AbstractBitdaricParams.ID_DARX_MAINNET)
            ? "" : null;
    ...
    public static final String SOURCE_URL = "https://github.com/bitdaric/bitdaric-wallet";
    public static final String BINARY_URL = "http://bitdaric.github.io/bitdaric-wallet/releases";

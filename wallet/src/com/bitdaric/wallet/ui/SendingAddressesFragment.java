...
import com.bitdaric.wallet.util.WholeStringBuilder;
...
public final class SendingAddressesFragment extends FancyListFragment
    ...
    private void handleShowQr(final String address, final String label) {
        final String uri = BitcoinURI.convertToBitcoinURI(Constants.NETWORK_PARAMETERS, address, null, label, null).replace(AbstractBitcoinNetParams.BITCOIN_SCHEME, "bitdaric");
    ...
    private void handleCopyToClipboard(final String address) {
        clipboardManager.setPrimaryClip(ClipData.newPlainText("BitDaric address", address));

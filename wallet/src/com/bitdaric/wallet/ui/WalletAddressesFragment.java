        ...
        activity.startActionMode(new ActionMode.Callback() {
            ...
            public boolean onActionItemClicked(final ActionMode mode, final MenuItem item) {
                ...
                case R.id.wallet_addresses_context_browse:
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.withAppendedPath(Uri.parse(Constants.EXPLORE_BASE_URL_ADDR),
                            getAddress(position).toBase58())));
            ...
            private void handleShowQr(final Address address) {
                final String uri = BitcoinURI.convertToBitcoinURI(address, null, config.getOwnName(), null).replace(AbstractBitcoinNetParams.BITCOIN_SCHEME, "bitdaric");
            ...
            private void handleCopyToClipboard(final Address address) {
                clipboardManager.setPrimaryClip(ClipData.newPlainText("BitDaric address", address.toBase58()));

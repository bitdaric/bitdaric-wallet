...
public abstract class InputParser {
    ...
    public abstract static class StringInputParser extends InputParser {
        ...
        public void parse() {
            ...
            } else if (input.startsWith("bitdaric:")) {
                try {
                    ...
                    log.info("got invalid bitdaric uri: '" + input + "'", x);
    ...
    private static final Pattern PATTERN_DUMPED_PRIVATE_KEY_UNCOMPRESSED = Pattern
            .compile((Constants.NETWORK_PARAMETERS.getId().equals(AbstractBitdaricParams.ID_DARX_MAINNET) ? "6" : "9") + "["
                    + new String(Base58.ALPHABET) + "]{50}");
    private static final Pattern PATTERN_DUMPED_PRIVATE_KEY_COMPRESSED = Pattern
            .compile((Constants.NETWORK_PARAMETERS.getId().equals(AbstractBitdaricParams.ID_DARX_MAINNET) ? "[Q]" : "c") + "["

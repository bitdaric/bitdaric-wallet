...
import com.bitdaric.wallet.ui.TransactionsAdapter.Warning;
import com.bitdaric.wallet.ui.send.RaiseFeeDialogFragment;
...
import com.bitdaric.wallet.util.ThrottlingWalletChangeListener;
...
public class WalletTransactionsFragment extends Fragment implements LoaderCallbacks<List<Transaction>>,
    ...
    public void onTransactionMenuClick(final View view, final Transaction tx) {
        ...
        popupMenu.getMenu().findItem(R.id.wallet_transactions_context_raise_fee)
                .setVisible(false); // No support on BitDaric yet (?)
                ...
                case R.id.wallet_transactions_context_browse:
                    if (!txRotation)
                        startActivity(new Intent(Intent.ACTION_VIEW,
                                Uri.withAppendedPath(Uri.parse(Constants.EXPLORE_BASE_URL_TX), tx.getHashAsString())));
                    else

...
package com.bitdaric.wallet.service;
...
import com.bitdaric.wallet.WalletBalanceWidgetProvider;
import com.bitdaric.wallet.data.AddressBookProvider;
import com.bitdaric.wallet.service.BlockchainState.Impediment;
import com.bitdaric.wallet.ui.WalletActivity;
        ...
        private void check() {
            ...
            if (impediments.isEmpty() && peerGroup == null) {
                ...
                peerGroup.addPeerDiscovery(new PeerDiscovery() {
                    private final PeerDiscovery normalPeerDiscovery = new DnsDiscovery(Constants.NETWORK_PARAMETERS); // DNS
